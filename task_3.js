...
const images = [
  ...
  let createItem = ({ url, alt }) => `<li><img src="${url}" alt="${alt}" class="image"</li>`;
  let gallPos = images.reduce((acc, item) => acc + createItem(item), "");
  let galleryRef = document.querySelector("#gallery");
  galleryRef.insertAdjacentHTML("afterbegin", gallPos);
